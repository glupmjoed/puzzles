...
Taken together, the expression `(\b\w+\b).*\1` matches a line containg a word, if
and only if the same word occurs again at some point on the right hand side (but
